 ...
 *
 * <p>The union–find data type models connectivity among a set of <em>n</em> sites, named 0 through
 * <em>n</em>–1. The <em>is-connected-to</em> relation must be an <em>equivalence relation</em>:
 *
 * <ul>
 *   <li><em>Reflexive</em>: <em>p</em> is connected to <em>p</em>.
 *   <li><em>Symmetric</em>: If <em>p</em> is connected to <em>q</em>, then <em>q</em> is connected
 *       to <em>p</em>.
 *   <li><em>Transitive</em>: If <em>p</em> is connected to <em>q</em> and <em>q</em> is connected
 *       to <em>r</em>, then <em>p</em> is connected to <em>r</em>.
 * </ul>
 *
 * <p>An equivalence relation partitions the sites into <em>equivalence classes</em> (or
 * <em>components</em>). In this case, two sites are in the same component if and only if they are
 * connected. Both sites and components are identified with integers between 0 and <em>n</em>–1.
 * Initially, there are <em>n</em> components, with each site in its own component. The
 * <em>component identifier</em> of a component (also known as the <em>root</em>, <em>canonical
 * element</em>, <em>leader</em>, or <em>set representative</em>) is one of the sites in the
 * component: two sites have the same component identifier if and only if they are in the same
 * component.
 *
 * <ul>
 *   <li><em>union</em>(<em>p</em>, <em>q</em>) adds a connection between the two sites <em>p</em>
 *       and <em>q</em>. If <em>p</em> and <em>q</em> are in different components, then it replaces
 *       these two components with a new component that is the union of the two.
 *   <li><em>find</em>(<em>p</em>) returns the component identifier of the component containing
 *       <em>p</em>.
 *   <li><em>connected</em>(<em>p</em>, <em>q</em>) returns true if both <em>p</em> and <em>q</em>
 *       are in the same component, and false otherwise.
 *   <li><em>count</em>() returns the number of components.
 * </ul>
 *
 * <p>The component identifier of a component can change only when the component itself changes
 * during a call to <em>union</em>—it cannot change during a call to <em>find</em>,
 * <em>connected</em>, or <em>count</em>.
 *
 * <p>This implementation uses quick find. Initializing a data structure with <em>n</em> sites takes
 ...
 * implementations of the same API, see {@link UF}, {@link QuickUnionUF}, and {@link
